...
import { playerContext, positionContext, nowPlayingContext } from './context';
import { AudioPlayerContext, NowPlayingContext } from './types';
...
export function AudioPlayerProvider({
  ...
  const nowPlayingIdContextValue = useMemo(
    () => ({
      nowPlayingId,
      setNowPlayingId,
    }),
    [nowPlayingId, setNowPlayingId]
  );
  ...
  return (
    <playerContext.Provider value={contextValue}>
      <positionContext.Provider value={positionContextValue}>
        <nowPlayingContext.Provider value={nowPlayingIdContextValue}>
          {children}
